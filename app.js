...
const tasks = {
    ...
    2: {
        ...
        explanation: "Показы: 40 млн × 3 = 120 млн показов. CPM из данных: ₽7,740,000 ÷ 82 млн × 1000 = ₽94.4. Стоимость: 120 млн × ₽94.4 ÷ 1000 = ₽11 328 000"
    },
    3: {
        type: 'select',
        correctAnswers: {
    ...
    6: {
        ...
        explanation: "VK: ₽1,800,000 ÷ 12 млн * 1000 = ₽150 за 1000 человек. За весь бюджет: ₽7,740,000 ÷ ₽150 × 1000 = 51.6 млн человек. Но такая концентрация рискованна из-за ограничений площадки и усталости аудитории."
    }
};
