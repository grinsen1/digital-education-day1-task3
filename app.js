...
const totals = {
    ...
    uniquePeople: 35000000,
    totalCookies: 52500000,
    totalBudget: 7740000,
    frequency: 2.34,
    cookieOverlap: 17500000,
    cookiesPerPerson: 1.5,
...
const tasks = {
    1: {
        type: 'radio',
        correctAnswer: 'b',
        explanation: "Правильно! 47 млн показов = это частота контакта. 82 млн показов ÷ 35 млн человек = 2.34 показа на человека в среднем. Это нормально и эффективно, так как для запоминания бренда нужно несколько контактов с рекламой."
    },
    2: {
        type: 'number',
        correctAnswers: {
    ...
    4: {
        type: 'radio',
        correctAnswer: 'b',
        explanation: "Верно! Прямое сравнение охватов некорректно из-за разных методик измерения, определений 'человека', целевых аудиторий, площадок и качества контакта. Важно оценивать не только охваты, но и конверсии в бизнес-результаты."
    },
    5: {
        type: 'number',
        correctAnswers: {
        ...
        explanation: "YouTube потеряет 30% охвата: 8 млн × 0.7 = 5.6 млн (вместо 8 млн). Общий охват уменьшится: 35 млн - 2.4 млн = 32.6 млн человек."
    },
    6: {
        type: 'number',
        correctAnswers: {
